...
public class CONSTANTS {
    ...
    public static final int SHARE =444 ;
    public static final int LOGOUT =000 ;
    public static final int RATE_US = 222;
    public static final int HELP = 666;

    public static final String ERROR = "Server is not responding, Please try again in a while";
